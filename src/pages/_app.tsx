...
function MyApp({ Component, pageProps, router }: AppProps) {
    ...
    return (
        <>
            <Head>
                <meta charSet="utf-8" />
                <title>TigerLake</title>
                <link rel="icon" href="/favicon.ico" />
                <meta name="viewport" content="width=device-width,initial-scale=1" />
                <meta name="theme-color" content="#000000" />
                <meta
                    name="keywords"
                    content="trixzy, trixzydev, tigerlake, TigerLake, web developer, github, typescript"
                />
                <meta name="description" content="Trixzy - Software Engineer" />
                <meta name="author" content="Trixzy" />
